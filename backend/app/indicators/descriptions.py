"""One-line descriptions for all 127 ta callables.

These exist so list_indicators and describe_indicator are searchable by intent
("bollinger", "trend strength", "money flow") rather than only by method name. The
registry deliberately carries caveats in its note field, not prose, so the two are kept
apart.
"""
...
DESCRIPTIONS: dict[str, str] = {
    ...
    "frama": "Fractal Adaptive Moving Average: adapts using fractal dimension of price.",
    ...
    "macd": "MACD: fast minus slow EMA, with a signal line and histogram.",
    ...
    "adl": "Accumulation Distribution Line: cumulative money flow from close position.",
    ...
    "rvol": "Relative Volume: current volume versus its recent average.",
    # oscillators
    ...
    "awesome_oscillator": "Awesome Oscillator: 5 versus 34 period midpoint momentum.",
    "accelerator_oscillator": "Accelerator Oscillator: acceleration of the Awesome Oscillator.",
    "ppo": "Percentage Price Oscillator: MACD expressed in percent, comparable across symbols.",
    "po": "Price Oscillator: difference between a fast and slow moving average.",
    ...
    "rvi": "Relative Vigor Index: close versus open relative to the bar range.",
    ...
    "stc": "Schaff Trend Cycle: MACD passed through a stochastic, fast trend signal.",
    ...
    "aroon": "Aroon up and down: how recently the high and low occurred.",
    ...
    "midprice": "Midprice: the average of the highest high and lowest low.",
